...
- Restore the complete integration runtime and translations from 1.0.9 after
  1.0.10 accidentally reverted them to 1.0.6.
- Restore container forecasts, calculated-flow-rate fallback, extended alarms,
  entity-ID preservation, option preservation, and persistent-state protections.
- Restore regression tests and CI removed in 1.0.10.
- Keep the dashboard, screenshots, and installation notes added in 1.0.10;
  restore documentation and release history for 1.0.7 through 1.0.9.
...
- This release was intended to change documentation only, but accidentally included the integration runtime from 1.0.6. Version 1.0.11 restores the 1.0.9 runtime.
