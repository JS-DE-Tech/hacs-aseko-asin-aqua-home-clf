...
DEFAULT_WATER_LEVEL_ERROR_LABELS = False
DEFAULT_TIME_CORRECTION_THRESHOLD_MINUTES = 5
MIN_TIME_CORRECTION_THRESHOLD_MINUTES = 1
MAX_TIME_CORRECTION_THRESHOLD_MINUTES = 10
...
CONF_WATER_LEVEL_ERROR_LABELS = "water_level_error_labels"
CONF_TIME_CORRECTION_THRESHOLD_MINUTES = "time_correction_threshold_minutes"
